 ...
 */
class tx_synthesis_reservedWords {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/synthesis/class.tx_synthesis_reservedwords.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/synthesis/class.tx_synthesis_reservedwords.php']);
}
