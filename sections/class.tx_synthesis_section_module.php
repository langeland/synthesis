...
class tx_synthesis_section_module extends tx_synthesis_sectionbase {
  var $sectionID = 'module';
	/**
	 * Renders the form in the synthesis; this was add_cat_module()
	 *
	 * @return	HTML
	 */
	function render_wizard() {
		...
		if(is_array($GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['synthesis']['add_cat_module'])) {
		  foreach($GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['synthesis']['add_cat_module'] as $_funcRef) {
...
<!-- ###BUTTON_GROUPS_RIGHT### -->';
		...
		$this->addFileToFileArray($pathSuffix.'moduleicon.gif',t3lib_div::getUrl(t3lib_extMgm::extPath('synthesis').'res/notfound_module.gif'));
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/synthesis/sections/class.tx_synthesis_section_module.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/synthesis/sections/class.tx_synthesis_section_module.php']);
}
