...
class tx_synthesis_section_emconf extends tx_synthesis_sectionbase {
  var $sectionID = 'emconf';

	/**
	 * Renders the form in the synthesis; this was add_cat_emconf()
	 *
	 * @return	[type]		...
	 */
	function render_wizard() {
		...
		if(is_array($GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['synthesis']['add_cat_emconf'])) {
			foreach($GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['synthesis']['add_cat_emconf'] as $_funcRef) {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/synthesis/sections/class.tx_synthesis_section_emconf.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/synthesis/sections/class.tx_synthesis_section_emconf.php']);
}
