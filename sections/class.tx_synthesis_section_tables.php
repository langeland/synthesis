...
class tx_synthesis_section_tables extends tx_synthesis_section_fields {
...
if (defined ( 'TYPO3_MODE' ) && $TYPO3_CONF_VARS [TYPO3_MODE] ['XCLASS'] ['ext/synthesis/sections/class.tx_synthesis_section_tables.php']) {
	include_once ($TYPO3_CONF_VARS [TYPO3_MODE] ['XCLASS'] ['ext/synthesis/sections/class.tx_synthesis_section_tables.php']);
}
