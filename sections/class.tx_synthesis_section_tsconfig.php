...
class tx_synthesis_section_tsconfig extends tx_synthesis_sectionbase {
  var $sectionID = 'tsconfig';

	/**
	 * Renders the form in the synthesis; this was add_cat_()
	 *
	 * @return	string		...
	 */
	function render_wizard() {
		...
		if(is_array($GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['synthesis']['add_cat_tsconfig'])) {
		  foreach($GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['synthesis']['add_cat_tsconfig'] as $_funcRef) {
