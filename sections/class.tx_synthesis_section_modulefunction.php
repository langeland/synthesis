...
class tx_synthesis_section_modulefunction extends tx_synthesis_sectionbase {
  var $sectionID = 'modulefunction';
	/**
	 * Renders the form in the synthesis; this was add_cat_modulefunction()
	 *
	 * @return	HTML
	 */
	function render_wizard() {
		...
		if(is_array($GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['synthesis']['add_cat_moduleFunction'])) {
			foreach($GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['synthesis']['add_cat_moduleFunction'] as $_funcRef) {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/synthesis/sections/class.tx_synthesis_section_modulefunction.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/synthesis/sections/class.tx_synthesis_section_modulefunction.php']);
}
