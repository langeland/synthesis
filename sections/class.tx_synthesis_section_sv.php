...
class tx_synthesis_section_sv extends tx_synthesis_sectionbase {
  var $sectionID = 'sv';
	...
	function render_wizard() {
		...
		if(is_array($GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['synthesis']['add_cat_services'])) {
		  foreach($GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['synthesis']['add_cat_services'] as $_funcRef) {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/synthesis/sections/class.tx_synthesis_section_sv.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/synthesis/sections/class.tx_synthesis_section_sv.php']);
}
