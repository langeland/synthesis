...
class tx_synthesis_section_pi extends tx_synthesis_sectionbase {
  var $sectionID = 'pi';

	/**
	 * Renders the form in the synthesis; this was add_cat_pi()
	 *
	 * @return	HTML
	 */
	function render_wizard() {
		...
		if(is_array($GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['synthesis']['add_cat_pi'])) {
		  foreach($GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['synthesis']['add_cat_pi'] as $_funcRef) {
...
',
			...
			$this->addFileToFileArray(
				...
				// Add wizard icon
			$this->addFileToFileArray($pathSuffix . 'ce_wiz.gif', t3lib_div::getUrl(t3lib_extMgm::extPath('synthesis') . 'res/wiz.gif'));
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/synthesis/sections/class.tx_synthesis_section_pi.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/synthesis/sections/class.tx_synthesis_section_pi.php']);
}
